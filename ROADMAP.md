...
- [x] **T-V12** — Script de démonstration réécrit en tonalité opérateur. L'ancienne version enchaînait les antithèses équilibrées, les triplets et les chutes aphoristiques — une voix qui s'entend comme générée. Nouveau registre : vocabulaire du métier (« le CT », « chauffeur », « la carte grise », « des bornes »), phrases courtes, chiffres dits à voix haute, silences notés comme des plans à part entière, une limite assumée à l'écran (les rapports sont mensuels), et une seule phrase de conclusion au lieu d'une par section. _(2026-09-15)_
