...
- [x] **T-D13** — Atterrissage du tableau de bord revu : plus lent et plus doux (1,1 s par bloc, cadence décélérante 0 → 880 ms, léger flou et montée de 22 px), le rail droit arrive derrière la colonne principale. Surtout : **une seule fois par session**, au moment où le voile de chargement se lève — plus d'animation à chaque navigation. Drapeau `fd-landed` en sessionStorage, remis à zéro par `signOut()`. _(2026-09-12)_
